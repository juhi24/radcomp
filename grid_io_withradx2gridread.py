...
from pyart.core.grid import Grid  #changed from relative path in grid_io to work in local dir
from pyart.io.cfradial import _ncvar_to_dict, _create_ncvar  #changed from relative path in grid_io to work in local dir
from pyart.io.common import _test_arguments  #changed from relative path in grid_io to work in local dir
...
def read_radx_grid(filename, exclude_fields=None, **kwargs):
    ...
    # below is altered from original read_grid to read in origin info form radx file
    ...
    # Below is altered from rad_grid to read in the correct variables and change the units of the data in the radx file
    ...
    # projection
    ### Below has been significantly altered form the original rad_grid to obtain the correct info from the radx file to plot data in basemap
    
    # Create necessary projection params dict for basemap and pyart from values in grid_mapping_0 variable in radx created file
